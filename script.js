function resolverEjercicio1() {
    let cadena = prompt("Ingrese una cadena para contar el número de vocales:");
    if (cadena === null || cadena.trim() === "") {
        alert("No se ingresó ninguna cadena.");
        return;
    }
    ...
    document.getElementById('resultadoTexto1').textContent = `La cadena "${cadena}" tiene ${vocales} vocales.`;
    document.getElementById('resultadoEjercicio1').style.display = 'block';
}

function resolverEjercicio2() {
    let cadena = prompt("Ingrese una cadena para imprimir cada carácter en mayúsculas:");
    if (cadena === null || cadena.trim() === "") {
        alert("No se ingresó ninguna cadena.");
        return;
    }
    ...
    document.getElementById('resultadoTexto2').textContent = `La cadena "${cadena}" en mayúsculas es:\n\n${cadenaMayusculas}`;
...
function resolverEjercicio11() {
    ...
    document.getElementById("resultadoTexto11").textContent = resultado;
    document.getElementById("resultadoEjercicio11").style.display = "block";
}

function resolverEjercicio12() {
    let a = parseInt(prompt("Ingrese el primer número:"));
    if (isNaN(a) || a <= 0) {
        alert("Por favor, ingrese un número válido.");
        return;
    ...
    document.getElementById("resultadoTexto12").textContent = resultado;
    document.getElementById("resultadoEjercicio12").style.display = "block";
}
